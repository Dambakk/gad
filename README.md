...
This is how the view component in iOS is defined. Each element needs the "implementation"- "adding"-, and "header"-part. Notice the "," after the elements under implementationFields. It is supposed to be there, removing it will cause an error.
